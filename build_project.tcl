...
proc CreateApplicationProject {app_name proc_name source_path workspace_dir} {
	...
	app config -name $app_name -add "include-path" $source_path/lib/include
	app config -name $app_name -add "library-search-path" $source_path/lib/lib
	app config -name $app_name -add "libraries" PropertyLib
    }
